...
def rocket_launch(r0, v0, max_time, dt, thrust_f, mass_loss_rate, fuel_m, spacecraft_m):
    ...
    rocket_m = spacecraft_m + fuel_m + const.m_H2*N_H2*N_box                            # initial rocket mass [kg]
