...
def main():
    ...
    plt.title("Maxwell-Boltzmann distribution for the absolute particle\nvelocity " + r'$v$' + f' when there are {N_H2:.0f} particles in the box')
    plt.tight_layout()
    fig = plt.gcf()
    plt.show()
    fig.savefig('/Users/paljettrosa/Documents/AST2000/100_particles.pdf')
    ...
    fig = plt.gcf()
    plt.show()
    fig.savefig('/Users/paljettrosa/Documents/AST2000/100000_particles.pdf')
