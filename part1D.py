...
N_box = (A_spacecraft/A_box)*20         # number of gasboxes                   
thrust_f = N_box*mean_f                 # the combustion chamber's total thrust force per second [N]
...
'''
There are 1.14544e+28 particles exiting the combustion chamber per second
The combustion chamber exerts a thrust of 158225 N
The combustion chamber loses a mass of 38.343 kg/s
The rocket uses a total of 39015.5 kg fuel to boost its speed 10000 m/s
'''
