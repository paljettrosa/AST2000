...
def enough_fuel(N_H2, fuel_m, t0, phi, home_pos, max_time, boosts=None):
    ...
    mass_loss_rate = 113.56180812432552 
...
for i in range(100):
    ...
    if i < 60:
        if distance >= 1e5:
            travel.boost([- (velocity[0] - Buttercup_vel[0])/18, 0])    #TODO VAR 18 OG 1E5 DA VI HADDE TALL FRA DEL 5
    if i == 60:
        travel.finish_video(r'/Users/paljettrosa/Documents/AST2000/MCast/data/lowering.xml')
    
    ''' filming the orbit to check if we've successfully lowered it '''

    if i == 80:
        travel.start_video()
travel.finish_video(r'/Users/paljettrosa/Documents/AST2000/MCast/data/lowered_orbit.xml')
...
for i in range(10):
    ...
    landing.take_picture(fr'/Users/paljettrosa/Documents/AST2000/MCast/data/scouting{i+1}.xml')
    if i != 9:
